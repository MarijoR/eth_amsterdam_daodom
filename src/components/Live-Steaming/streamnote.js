...
export default function Streamnote() {
...
<div>
    ...
    >
       ...
       <div style={{display: 'flex', justifyContent:'center', alignItems:'center'}}>
       <p>NOTE: To start a video stream, please use a broadcaster software like OBS/Streamyard</p>
       </div>
       <div style={{display: 'flex', justifyContent:'center', alignItems:'center'}}>
       <p>Ingest URL: rtmp://rtmp.livepeer.com/live</p>
       </div>
       <div style={{display: 'flex', justifyContent:'center', alignItems:'center'}}>
       <p>Stream key: {key}</p>
       </div>
